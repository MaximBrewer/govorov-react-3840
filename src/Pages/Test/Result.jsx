            ...
            <div className={`relative w-full h-full overflow-hidden`}>
                <div className={`w-full h-full relative`}>
                    <div className={`w-full h-full flex flex-col`}>
                        ...
                        <div className={`pr-[40rem] relative text-navy-40 w-full h-full flex flex-col ${classes.menu}`}>
                            <div className={`pt-[64px] pr-16 pl-[120px]`}>
                            ...
                            <div className={`text-white flex flex-col items-center grow justify-center`}>
                                ...
                                <a href="#" onClick={e => {
                                    e.preventDefault()
                                    setResults({})
                                }} className={`mb-40 block cursor-pointer rounded-[20px] text-navy-80 transition bg-navy-10 hover:bg-navy-40 px-[80px] py-[68px]`}>
