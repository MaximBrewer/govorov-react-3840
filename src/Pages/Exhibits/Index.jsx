        ...
        <>
            <div className={`relative w-full h-full overflow-hidden`}>
                <div className={`h-full w-full top-0 left-0 absolute pr-[40rem]`}>
                    <svg className={`text-navy-80 absolute right-0 top-0 pointer-events-none ${classes.starR}`} width="3010" height="2160" viewBox="0 0 1505 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M854.742 -12H1610V530.076V1189.42H1244.93H854.742H420.5L626 621.416L0 273.416H734L854.742 -12Z" fill="currentColor" />
                    </svg>
                </div>
                <div className={`w-full h-full relative pr-[40rem]`}>
                    <div className={``}>
                        <div className={`relative z-10 pt-[200px] pb-[162px] flex flex-col justify-between h-full`}>
                            <div className={`pl-[120px] pr-[80px] flex items-center mb-[40px] justify-between`}>
                                ...
                                <DelayLink to={`/exhibits`} className={`relative -top-[2px] text-navy-20 border-4 border-navy-60 rounded-full py-12 px-16 flex items-center space-x-6 text-[3rem] leading-none opacity-0 ${classes.btn}`}>
                            ...
                            <div className={`z-10 justify-center flex items-center space-x-6 w-full text-bronze-100 font-semibold font-raleway text-[36px] leading-[44px]`}>
