            ...
            <div className={`relative w-full h-full overflow-hidden`}>
                <div className={`w-full h-full relative`}>
                    ...
                    <div className={` ${classes.bg}`}>
                        ...
                        <div className={`absolute bottom-0 bg-bronze-120 left-[848px] right-[640px] top-0 pointer-events-none ${classes.bg}`}
                            style={{
                        ...
                        <img src={`./img/biography/victory/govorov.png`} alt={``} className={`absolute left-[1184px] bottom-[0px] w-[2106px] h-[1958px] pointer-events-none ${classes.sectionGovorov}`} />
                        <div className={`w-[848px] bg-bronze-120 h-full top-0 left-0 absolute flex items-center justify-center`}>
                            <div className={`w-[800px] h-[1076px] bg-contain ${classes.sectionSign}`} style={{
                                backgroundImage: `url('${`./img/biography/victory/sign.png`}')`,
                                backgroundBlendMode: `luminosity`
                            }}></div>
                        </div>
                        <div className={`max-w-[2000px] pointer-events-none flex pl-[800px] pt-[212px] leading-[220px] text-[240px] font-bold tracking-[2%] relative title-shadow`}>
                            <div className={classes.post}>{props.title}</div>
                        </div>
                        <div className={`pl-[800px]  max-w-[2000px] pt-[48px] tracking-[.06em] relative pointer-events-none`}>
